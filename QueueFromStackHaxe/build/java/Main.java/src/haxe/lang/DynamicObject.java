...
public class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		//line 42 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
	...
	{
		//line 46 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
		...
		//line 52 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
		{
			...
			while (( _g < _g1.length ))
			{
				...
				//line 52 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
				 ++ _g;
				//line 54 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
				if (first) 
				{
				...
				{
					//line 57 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
					ret.add(haxe.lang.Runtime.toString(","));
				}
		...
		//line 62 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
		if ( ! (first) ) 
		{
			//line 62 "/usr/local/lib/haxe/std/java/internal/HxObject.hx"
			ret.add(haxe.lang.Runtime.toString(" "));
