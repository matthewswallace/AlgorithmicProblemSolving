...
public class Reflect extends haxe.lang.HxObject
{
	...
	public static java.lang.Object field(java.lang.Object o, java.lang.String field)
	{
		...
		{
			//line 42 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
			return ((haxe.lang.IHxObject) (o) ).__hx_getField(field, false, false, false);
		}
		
		//line 44 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 50 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
		if (( o instanceof haxe.lang.IHxObject )) 
		{
		...
		{
			//line 53 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
	...
	public static haxe.root.Array<java.lang.String> fields(java.lang.Object o)
	{
		...
		if (( o instanceof haxe.lang.IHxObject )) 
		{
			...
			//line 90 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
			return ret;
		}
		else
		{
			...
			{
				//line 92 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
				return haxe.root.Type.getClassFields(((java.lang.Class) (o) ));
			}
			else
			{
				//line 94 "/usr/local/lib/haxe/std/java/_std/Reflect.hx"
